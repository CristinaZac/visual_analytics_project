              ...
              <b-row class="w-100">
                <b-button-group class="mt-3 mb-3 ml-3 pl-3 w-100">
                  ...
                  <b-button variant="dark" class="pr-5 pl-5 w-100" id="buttonMap"
                            v-b-toggle.collapse-2> St. Himark map
                  </b-button>
                </b-button-group>
              </b-row>
                ...
                <b-sidebar id="sidebar-1" title="Data analysis" shadow>
                  <div class="px-3 py-2">
                    ...
                    <p class="text-justify">
                      ...
                      so on) in a reduced size of the box and a low to none
                    ...
                    <p class="text-justify">
                      ...
                      boxplot were the most efficient tools to use.
              ...
              <b-row>
                <b-col>
                  <h5>
                    ...
                    Power:
                    {{ power.mean.toPrecision(2) }}
                  </h5>
                  <h5>
                    <b-icon icon="building"></b-icon>
                    Buildings:
                    {{ buildings.mean.toPrecision(2) }}
                  </h5>
                  <h5>
                    <b-icon icon="suit-heart"></b-icon>
                    Medical:
                    {{ medical.mean.toPrecision(2) }}
                  </h5>
                  <h5>
                    <b-icon icon="droplet"></b-icon>
                    Sewer and water:
                    {{ sewer_and_water.mean.toPrecision(2) }}
                  </h5>
                  <h5>
                    <b-icon icon="cone-striped"></b-icon>
                    Roads and bridges:
                    {{ roads_and_bridges.mean.toPrecision(2) }}
                  </h5>
                  <h5>
                    <b-icon icon="bullseye"></b-icon>
                    Shake intensity:
                    {{ shake_intensity.mean.toPrecision(2) }}
                  </h5>
                </b-col>
                <b-col>
...
export default {
  ...
  methods: {
    ...
    // function to refresh values stacked bar chart
    refreshStacked() {
      if (this.myButtonTimeline === true && this.days.value !== 'All') {
